    ...
    <body>
		...
		<section>
			<fieldset>
				...
				<label><h6>Você é participante das seguintes equipes:</h6></label><br><br>
			    ...
			    <table style="text-align: center;">
		            <tr>
		                ...
		                $stmt = $conn->prepare("SELECT nome_equipe FROM equipes WHERE (email1 = '$email') or (email2 = '$email') or (email3 = '$email') or (email4 = '$email') or (email5 = '$email')");
			            ...
			            <div id="item">
			                ...
			                <br><br><br><a href="equipe.php"><input type="submit" id="participantes" class="form-group" name="participantes" value="Exibir Participantes" readonly></a>
			            </div>
			        </tr>
			    </table>
			</fieldset>

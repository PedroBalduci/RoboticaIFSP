    ...
    <body>
		...
		<section>
			<fieldset>
				...
				<label><h6>Os participantes das equipes são:</h6></label><br><br>
			    ...
			    <table style="text-align: center;">
		            <tr>
		                ...
		                $stmt = $conn->prepare("SELECT nome_equipe, responsavel, email1, email2, email3, email4, email5 FROM equipes WHERE (email1 = '$email') or (email2 = '$email') or (email3 = '$email') or (email4 = '$email') or (email5 = '$email')");
			            ...
			            <div id="item">
			                ...
			                <br><a href="minhas_equipes.php"><input type="submit" id="voltar" class="form-group" name="voltar" value="Voltar" readonly></a>
			            </div>
			        </tr>
			    </table>
			</fieldset>
